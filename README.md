...
DUE TO A RECENT UPDATE, THIS DOCUMENTATION AS WELL AS THE EXAMPLE FILE ARE CURRENTLY PARTIALLY OBSOLETE, PLEASE CHECK THE HEADER SOURCE DIRECTLY OR WAIT A FEW DAYS FOR AN UPDATE OF THE DOCUMENTATION.
